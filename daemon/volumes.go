...
func (container *Container) setupMounts() error {
	...
	if container.IntrospectionSocketPath != "" {
		mounts = append(mounts, execdriver.Mount{Source: container.IntrospectionSocketPath, Destination: "/var/run/docker.sock", Writable: true, Private: true})
	}
