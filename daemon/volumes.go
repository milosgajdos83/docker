...
func (container *Container) setupMounts() error {
	...
	if container.SocketPath != "" {
		mounts = append(mounts, execdriver.Mount{Source: container.SocketPath, Destination: "/var/run/dockerchan.sock", Writable: true, Private: true})
	}
